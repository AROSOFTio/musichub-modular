...
export function MobileDrawer() {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "fixed inset-y-0 left-0 z-50 flex w-80 max-w-[85vw] flex-col bg-white shadow-2xl transition-transform duration-300 ease-in-out lg:hidden",
        ...
        <nav className="flex-1 overflow-y-auto px-4 py-4 space-y-1">
          {isAuthenticated && canAccessAdmin && (
            <Link
              ...
              className="mb-3 flex items-center gap-4 rounded-2xl bg-violet-50 px-4 py-3.5 text-base font-bold text-violet-700 transition-colors"
            >
          ...
          {isAuthenticated ? (
            <>
              ...
              <button
                ...
                className="flex w-full items-center gap-3 rounded-2xl bg-red-50 px-4 py-3.5 text-base font-semibold text-red-600 transition-colors hover:bg-red-100"
              >
